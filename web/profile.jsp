<%-- 
    Document   : profile
    Created on : 5 Feb, 2021, 1:09:11 AM
    Author     : HaMdaan
--%>
...
clip-path: polygon(30% 0%, 70% 0%, 100% 0, 100% 90%, 67% 93%, 33% 100%, 0 91%, 0 0);
            ...
            body{
                background: url(img/allpostbanner.jpg);
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
          <a class="nav-link" href="#"><span class="fa fa-tablet"></span> Ali & Android<span class="sr-only">(current)</span></a>
      </li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <form id="add-post" action="AddPostServlet" method="post">
              ...
              <div class="form-group">
                  <textarea name="pCode" class="form-control" style="height: 200px;" placeholder="Enter your Codesnipet (if any)"></textarea>
              </div>
              <div class="form-group">
